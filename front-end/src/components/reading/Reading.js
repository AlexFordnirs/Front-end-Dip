...
function Reading() {
    ...
    function show_a1() {
        ...
        fetch(`http://51.107.7.88:3001/Reading/?type_name=Reading&level_name=A1`, {
            headers: {
                'accept': "text/plain",
    ...
    function show_a2() {
        ...
        fetch(`http://51.107.7.88:3001/Reading/?type_name=Reading&level_name=A2`, {
            headers: {
                'accept': "text/plain",
                "Content-Type": "application/json",
                "Access-Control-Allow-Origin": "*",
    ...
    function show_b1() {
        ...
        fetch(`http://51.107.7.88:3001/Reading/?type_name=Reading&level_name=B1`, {
            headers: {
                'accept': "text/plain",
                "Content-Type": "application/json",
                "Access-Control-Allow-Origin": "*",
    ...
    function show_b2() {
        ...
        fetch(`http://51.107.7.88:3001/Reading/?type_name=Reading&level_name=B2`, {
            headers: {
                'accept': "text/plain",
                "Content-Type": "application/json",
                "Access-Control-Allow-Origin": "*",
        ...
        <div>
            ...
            <div className={"main-cont"}>
                ...
                <div ref={a1Ref} className={"test-cont"}>
                    {tests.map((test, i)=>{
                        return <NavLink key={i} className={"test-btn"} to={`/ReadingTest/${test._id}`}>{test.name_task}</NavLink>
                    })}
                </div>
